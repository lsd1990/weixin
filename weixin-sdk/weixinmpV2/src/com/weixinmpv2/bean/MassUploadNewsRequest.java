...
public class MassUploadNewsRequest implements Serializable {
    ...
    public List<Article> articles = new ArrayList<MassUploadNewsRequest.Article>(); //图文消息，一个图文消息支持1到10条图文
    
    public void addArticle(String thumbMediaId, String author, String title, String contentSourceUrl, String content
    ...
    public static class Article implements Serializable {
        ...
        public String toString() {
			  return String.format("thumbMediaId=[%s], author=[%s], title=[%s], contentSourceUrl=[%s], content=[%s], digest=[%s], showCoverPic=[%s]",
					  thumbMediaId, author, title, contentSourceUrl, content, digest, showCoverPic);
        }
	...
	public static class Response extends BaseResp{
		...
		@Override
        public String toString() {
	        return String.format("type=[%s], mediaId=[%s], createdAt=[%s]", type, mediaId, createdAt);
        }
	}
}
